...
//        provider.setProperty("password", dbProperties.getUsername());
...
//        try {
//            if (MISConstants.FILE_TYPE_PDF.equals(fileFormat)) {
//                PdfReportUtil.createPDF(report, out);
//            } else if (MISConstants.FILE_TYPE_XLSX.equals(fileFormat)) {
//                ExcelReportUtil.createXLSX(report, out);
//            } else if (MISConstants.FILE_TYPE_HTML.equals(fileFormat)) {
...
//                responseEntity = new ResponseEntity<>(out, MISUtility.getHeader(fileFormat), HttpStatus.OK);
//            }
//        }
